...
while(True):
    ...
    for (x,y,w,h) in eyes:
        ...
        if prediction[0][0]>0.30:
            cv2.putText(frame,"Closed",(10,height-200), font, 1,(255,255,255),1,cv2.LINE_AA)
            cv2.putText(frame,'Score:'+str(score),(100,height-200), font, 1,(255,255,255),1,cv2.LINE_AA)
            score=score+1
            print("Close Eyes")
            if(score > 20):
                try:
